...
try {
    ...
    document.addEventListener("DOMContentLoaded", function () {
        ...
        if (savedTheme) {
            ...
            // Optional: You can set a default based on user's system preference
...
// Optional: Apply theme immediately (without waiting for DOMContentLoaded)
// This can help prevent flickering on page load
(function () {
    const savedTheme = localStorage.getItem("preferred-theme");
    if (savedTheme) {
